...
class Origin:
    ...
    def __init__(self, **kwargs):
        ...
        self.departure_time_planned = datetime.strptime(
            kwargs.get("departureTimePlanned", "")[:-1], "%Y-%m-%dT%H:%M:%S"
        )
        self.departure_time_estimated = datetime.strptime(
            kwargs.get("departureTimeEstimated", "")[:-1], "%Y-%m-%dT%H:%M:%S"
        )
